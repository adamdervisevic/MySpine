...
export const Layout22 = (props: Layout22Props) => {
  ...
  return (
    <section
      id="o-nama" /* <= VAŽNO: anchor id */
      className="px-[5%] py-16 md:py-24 lg:py-28 bg-gradient-to-r from-green-200 via-white to-blue-200 scroll-mt-28"
    >
      <div className="container">
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:items-center md:gap-x-12 lg:gap-x-20">
          <div>
            ...
            <p className="mt-4 max-w-prose text-lg leading-relaxed text-gray-800">{description}</p>
          </div>
