    ...
    <div className="container mx-auto">
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="lg:w-1/2 w-full">
          ...
          <ul className="space-y-4 text-lg">
            <li>
              ...
              <p>Knez Mihajlova 46,<br />Smederevo, Srbija</p>
            </li>
            <li>
              <span className="font-semibold">Telefon:</span>
              <p>
                <a href="tel:062777566" className="hover:underline hover:text-blue-600 transition">
                  062777566
                </a>
              </p>
            </li>
            <li>
              ...
              <p>
                <a href="mailto:myspine.smederevo@gmail.com" className="hover:underline hover:text-blue-600 transition">
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center">
          <div className="w-full h-80 rounded-xl overflow-hidden shadow border border-gray-200">
           <iframe
